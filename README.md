...
## 规则总数
```
更新时间: 2022-04-11 12:58:08 （北京时间） 

AdRules（For AdBlock）规则数量: 89245 

AdRules（For AdGuard）规则数量: 107133 

AdRules（For DNS）规则数量: 114179 

AdRules（For Adaway）规则数量: 120046 

AdRules Allowlist 规则数量: 17893 

AdRules Ad Domains List 数量: 120046 

AdRules AdBlock Full List 规则数量: 238696 

AdRules AdGuard Full List 规则数量: 191108 
``` 
## 说明
...
| AdRules Allowlist | [Link](https://raw.githubusercontent.com/Cats-Team/AdRules/main/hosts.txt)|[Link](https://cats-team.coding.net/p/adguard/d/AdRules/git/raw/main/hosts.txt)|[一键订阅](https://subscribe.adblockplus.org/?location=https://cats-team.coding.net/p/adguard/d/AdRules/git/raw/main/hosts.txt) |
